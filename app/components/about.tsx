export default function About() {
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center pb-10">
      ...
      <br></br>
      <div className="text-3xl archivo text-center w-[70vw] mt-10 mb-10">I specialize in developing Saa platforms, AI-driven products, and interactive 3D web experiences using technologies like Next.js, Node.js, and Three.js.</div>
